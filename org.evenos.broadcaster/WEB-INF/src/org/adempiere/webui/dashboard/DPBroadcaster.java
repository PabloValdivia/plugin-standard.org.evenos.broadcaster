...
public class DPBroadcaster extends DashboardPanel implements EventListener<Event>, ITopicSubscriber<Map<String,Integer>> {//, EventHandler{
	...
	public void onEvent(Event event) throws Exception {
		...
		if(eventName.equals(Events.ON_CLICK)){
			if(comp.equals(checkboxIsOnline)){
				log.fine("Changed online Users only: " + checkboxIsOnline.isSelected());	
	...
	private void doOnClick(Component acomp) {
		...
		BroadcasterMessageWindow w = new BroadcasterMessageWindow(this.ad_user_id,
				(Integer)comp.getAttribute(BroadcasterTreeModel.ATTR_AD_CLIENT_ID),
				(Integer)comp.getAttribute(BroadcasterTreeModel.ATTR_AD_ORG_ID),
				(Integer)comp.getAttribute(BroadcasterTreeModel.ATTR_AD_ROLE_ID),
				(Integer)comp.getAttribute(BroadcasterTreeModel.ATTR_AD_USER_ID),
				(Integer)comp.getAttribute(BroadcasterTreeModel.ATTR_C_COUNTRY_ID),
				(Integer)comp.getAttribute(BroadcasterTreeModel.ATTR_C_REGION_ID)
		);
		w.setPage(this.getPage());
		w.doHighlighted();
